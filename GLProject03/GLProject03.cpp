...
std::uniform_real_distribution<float> bounce(0.05f, 0.15f);
...
void triangle::move()
{
	GLfloat temp[3][2]{ {vertices[0][0],vertices[0][1]},
	{vertices[1][0],vertices[1][1]},
	{vertices[2][0],vertices[2][1]} };
	if ((vertices[0][0] - bound_x) < -1.0f)
	{
		
		bound_x *= -1.f;
	}
	else if ((vertices[1][0] - bound_x) < -1.0f)
	{
		/*vertices[0][1] += 0.2;
		vertices[1][0] -= 0.2;
		vertices[2][0] += 0.2;
	...
	else if ((vertices[0][1] + bound_y) > 1.0f)
	{
		/*vertices[0][1] += 0.2;
		vertices[1][0] -= 0.2;
		vertices[2][0] += 0.2;
	...
	else if ((vertices[1][1] + bound_y) > 1.0f)
	{
		/*vertices[0][0] += 0.2;
		vertices[1][1] += 0.2;
		vertices[2][0] -= 0.2;
	...
	else if ((vertices[0][0] + bound_x) > 1.0f)
	{
		/*vertices[0][0] += 0.2;
		vertices[1][1] += 0.2;
		vertices[2][0] -= 0.2;
